...
<PageTitle title="Deploying to Github Pages"/>
...
<br/>
<NextPage nextPage="Contributing Guide" previousPage="Heroku" prevHref="/docs/deployment/heroku" nextHref="/docs/contributing/contributing-guide"/>
</MDXDocs>
