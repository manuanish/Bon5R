        ...
        <div className="grow mt-[100px] overflow-scroll invisible md:visible w-[0px] md:w-full lg:w-fit z-50">
          <div className="flex gap-5">
            <div className="group hover:bg-white duration-150 p-4 min-w-[350px] w-[350px] min-h-[340px] bg-slate-800 rounded-lg markdown-body text-slate-500 shadow-2xl z-50">
              <p className="group-hover:text-black duration-150 font-bold text-2xl">My post title</p>
              <p className="text-slate-700 group-hover:text-gray-300 duration-150">Posted at 3/14/15</p>
            ...
            <div className="flex flex-col gap-5">
              <div className="group hover:bg-white duration-150 p-4 w-[310px] h-fit bg-slate-800 rounded-lg text-slate-500 shadow-2xl">
                <h3 className="font-extrabold text-xl duration-150 group-hover:text-black">
                  <span className="grayscale group-hover:grayscale-0 duration-150"><span className="text-slate-600 duration-15 ">🔥</span></span> &nbsp;Page
                  Header
                </h3>
              </div>
              <div className="shadow-2xl group">
                <div className="p-4 w-[310px] h-[100px] bg-slate-800 duration-150 rounded-lg text-slate-500 hover:bg-[#282C34]">
                  <pre>
                    <code className="text-slate-600 group-hover:text-[#C678DD] duration-150">function</code>
                    <code className="text-slate-500 group-hover:text-[#61AFEF] duration-150">
                      &nbsp;syntaxHighlight
                    </code>
                    <code className="text-slate-600 group-hover:text-[#ABB2BF] duration-150">&#40;&#41;</code>
                    <code className="text-slate-600 group-hover:text-[#ABB2BF] duration-150">&nbsp;&#123;</code>
                    <br />
                    ...
                    <code className="text-slate-600 group-hover:text-[#ABB2BF] duration-150">.</code>
                    <code className="text-slate-500 group-hover:text-[#61AFEF] duration-150">log</code>
                    <code className="text-slate-500 group-hover:text-[#ABB2BF] duration-150">&#40;</code>
                    <code className="text-slate-600 group-hover:text-[#98C379] duration-150">&#34;Hello!&#34;</code>
                    <code className="text-slate-500 group-hover:text-[#ABB2BF] duration-150">&#41;&#59;</code>
                    <br />
                    <code className="text-slate-600 group-hover:text-[#ABB2BF] duration-150">&#125;</code>
                  </pre>
