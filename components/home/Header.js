        ...
        <div className="flex items-center">
          <nav>
            <ul className="flex items-center space-x-8">
              <li>
                <a className="hover:text-orange-400" href="/docs/getting-started/installation">Docs</a>
              </li>
              <li>
