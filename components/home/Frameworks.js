...
export default function Frameworks() {
  return (
    <div className="p-20 bg-transparent bg-gradient-to-t from-slate-900 via-slate-900 to-transparent w-full">
      ...
      <p className="mt-4 space-y-6 text-slate-500 text-left max-w-[510px]">
        ...
        <i>without learning any new code</i>.
      </p>
      <a
      ...
      <div className="md:p-20 pt-10 md:flex md:justify-evenly w-full mt-10 overflow-scroll">
